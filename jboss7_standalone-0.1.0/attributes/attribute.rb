...
default['jboss7']['version'] = '7.1.1.Final'
default['jboss7']['url'] = "http://download.jboss.org/jbossas/7.1/jboss-as-#{node['jboss7']['version']}/jboss-as-#{node['jboss7']['version']}.tar.gz"
default['jboss7']['testweb_url'] = "http://www.cumulogic.com/download/Apps/"
default['jboss7']['testweb_archive'] = "testweb.zip"
